...
# Install Arch base
clear
pacstrap /mnt base linux linux-firmware git vim nano less man dhcpcd sudo pacman-contrib reflector zsh fish grub efibootmgr os-prober openssh base-devel
